...
onready var replay_btn = get_node("../Top_ui/Replay_Button")
...
func screen_in():
	...
	$Tween.start()
	$Replay_Button2.set_global_position(replay_btn.rect_global_position)
	$finger.global_position = replay_btn.rect_global_position + Vector2(30,30)
