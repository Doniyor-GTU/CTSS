...
func set_initial_board():
	add_a_brick_to_grid(Vector2(1,0), "star")
	add_a_brick_to_grid(Vector2(1,1), "star")
	add_a_brick_to_grid(Vector2(5,0), "star")
	add_a_brick_to_grid(Vector2(5,2), "star")
	add_a_brick_to_grid(Vector2(6,1), "star")
	add_a_brick_to_grid(Vector2(7,1), "star")
	add_a_brick_to_grid(Vector2(0,3), "square")
	add_a_brick_to_grid(Vector2(2,3), "square")
	add_a_brick_to_grid(Vector2(3,0), "square")
	add_a_brick_to_grid(Vector2(3,1), "square")
	add_a_brick_to_grid(Vector2(1,5), "circle")
	add_a_brick_to_grid(Vector2(1,7), "circle")
	add_a_brick_to_grid(Vector2(5,5), "triangle")
	add_a_brick_to_grid(Vector2(5,6), "triangle")
	add_a_brick_to_grid(Vector2(6,4), "triangle")
	add_a_brick_to_grid(Vector2(7,4), "triangle")
	add_a_brick_to_grid(Vector2(2,0), "triangle")
	add_a_brick_to_grid(Vector2(2,1), "triangle")
	add_a_brick_to_grid(Vector2(4,2), "square")
		...
		if Input.is_action_just_released("ui_touch") and hammer_booster_step == 1:
			...
			if pos == Vector2(4,1):
				...
				if grid_array[pos.x][pos.y] != null:
					...
					finger.position = grid_to_pixel(Vector2(5,2)) + Vector2(5,5)
					finger.z_index = 3
				else:
					print("add shape")
...
func _on_Top_ui_hammer_booster_pressed():
	add_borders()
	stop_finger_animation()
	finger.position = grid_to_pixel(Vector2(4,1)) + Vector2(10,10)
	finger.start_animation(Vector2(0,0),Vector2(0,0), "oneTap")
